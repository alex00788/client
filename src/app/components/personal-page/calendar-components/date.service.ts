...
export class DateService {                                            //moment() это текущая дата
  ...
  public switchOrg: BehaviorSubject<boolean> = new BehaviorSubject(false)
  ...
  public openEmployee: BehaviorSubject<boolean> = new BehaviorSubject(false)
  ...
  public allUsersSelectedOrgDuplicateForShowEmployees: BehaviorSubject<any> = new BehaviorSubject([])
  ...
  public idOrgWhereSelectedEmployee: BehaviorSubject<any> = new BehaviorSubject('')
  public nameOrgWhereSelectedEmployee: BehaviorSubject<any> = new BehaviorSubject('')
  public nameOrganizationWhereItCameFrom: BehaviorSubject<any> = new BehaviorSubject('')
  public nameSelectedOrg: BehaviorSubject<any> = new BehaviorSubject('')
  ...
  public recordingDays: BehaviorSubject<any> = new BehaviorSubject('')
